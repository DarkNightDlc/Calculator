...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((windowName, options) => {
  ...
  const browserOptions = _objectSpread(_objectSpread(_objectSpread({}, options), state), {}, {
  ...
  win = new electron__WEBPACK_IMPORTED_MODULE_11__.BrowserWindow(browserOptions);
...
var toString = __webpack_require__(/*! ../internals/to-string */ "./node_modules/core-js-pure/internals/to-string.js");
var shared = __webpack_require__(/*! ../internals/shared */ "./node_modules/core-js-pure/internals/shared.js");
var NATIVE_SYMBOL_REGISTRY = __webpack_require__(/*! ../internals/native-symbol-registry */ "./node_modules/core-js-pure/internals/native-symbol-registry.js");
...
(async () => {
  ...
  if (isProd) {
    ...
    await mainWindow.loadURL(`http://localhost:${port}/home`); //mainWindow.webContents.openDevTools();
  }
})();
